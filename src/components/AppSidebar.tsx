...
export const AppSidebar: React.FC<AppSidebarProps> = ({
  ...
  return (
    <aside
      id="app-left-sidebar"
      className={`w-full ${
        isCollapsed ? 'md:w-20 p-3 sm:p-3' : 'md:w-72 lg:w-80 p-4 sm:p-5'
        ...
        <nav className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              <div
                className={`w-8 h-8 rounded-xl flex items-center justify-center transition-colors ${
                  activeTab === 'practice' ? 'bg-white/20 text-white' : 'bg-blue-50 text-blue-600'
                }`}
              >
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-8 h-8 rounded-xl flex items-center justify-center transition-colors ${
                  activeTab === 'deck' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-700'
                }`}
              >
            ...
            {!isCollapsed ? (
              <span
                className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                  activeTab === 'deck' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'
                }`}
              >
                {totalCards}
              </span>
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-8 h-8 rounded-xl flex items-center justify-center transition-colors ${
                  activeTab === 'settings' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-700'
                }`}
              >
